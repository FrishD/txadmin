...
import { BoxIcon, ChevronRightSquareIcon, DnaIcon, EyeIcon, FileEditIcon, GavelIcon, HourglassIcon, LayoutDashboardIcon } from 'lucide-react';
    ...
    return <div className='relative'>
        ...
        <div className={cn(isConfigPending && 'opacity-0 pointer-events-none')}>
            ...
            <div className="space-y-1 select-none">
                ...
                <MenuNavLink href="/pc_checker" disabled={!hasPerm('players.pc_checker')}>
                    <DnaIcon className="mr-2 h-4 w-4" />PC Checker
                </MenuNavLink>
