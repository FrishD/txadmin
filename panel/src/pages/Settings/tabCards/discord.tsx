    ...
    return (
        ...
        >
            ...
            <SettingItem label="Blacklist Role ID" htmlFor={cfg.blacklistRole.eid} showOptional>
                ...
                />
                <SettingItemDesc>
                    The ID of the role to assign to blacklisted players. <br />
                    To get the role ID, go to Discord's settings and
                    <TxAnchor href="https://support.discordapp.com/hc/article_attachments/115002742731/mceclip0.png"> enable developer mode</TxAnchor>, then right-click on the role and select "Copy ID".
                </SettingItemDesc>
            </SettingItem>
            <SettingItem label="Complementary Role ID" htmlFor={cfg.complementaryRole.eid} showOptional>
                ...
                />
                <SettingItemDesc>
                    The ID of the role to remove when a player is blacklisted. <br />
                    To get the role ID, go to Discord's settings and
                    <TxAnchor href="https://support.discordapp.com/hc/article_attachments/115002742731/mceclip0.png"> enable developer mode</TxAnchor>, then right-click on the role and select "Copy ID".
                </SettingItemDesc>
            </SettingItem>
