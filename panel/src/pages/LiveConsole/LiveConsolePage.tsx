...
export default function LiveConsolePage() {
    ...
    const getLineColor = (line: string) => {
        ...
        if (lowerLine.includes('success') || lowerLine.includes('ok') || lowerLine.includes('started')) {
            return ANSI.GREEN;
        }
        return ''; // No color
    }
    ...
    const writeToTerminal = (data: string) => {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            const prefix = termPrefixRef.current.lastEol
                ...
                : '';
            if (i < lines.length - 1) {
                term.writeln(prefix + lineColor + line, writeCallback);
                ...
                if (wasEolStripped) {
                    ...
                    term.write(prefix + lineColor + line, writeCallback);
