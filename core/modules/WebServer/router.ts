...
export default () => {
    ...
    //Admin Manager
    router.get('/admins/list', apiAuthMw, routes.admins_list);
    router.get('/adminManager/getApprovers', apiAuthMw, routes.adminManager_getApprovers);
    ...
    */
    ...
    router.post('/player/:action', apiAuthMw, routes.player_actions);  // THIS HANDLES target, untarget, and all other actions
    ...
    //Wager Blacklist routes
    router.get('/wagerblacklist/list', apiAuthMw, routes.wagerBlacklist_list);
    router.get('/wagerblacklist/stats', apiAuthMw, routes.wagerBlacklist_stats);
    router.post('/wagerblacklist/revoke', apiAuthMw, routes.wagerBlacklist_actions);

    //Host routes
    router.get('/host/status', hostAuthMw, routes.host_status);

    //Statistics routes
    router.get('/statistics/all', apiAuthMw, routes.statistics_page);
    router.get('/statistics/admin/:name', apiAuthMw, routes.statistics_getAdmin);
