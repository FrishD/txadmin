...
import { DiscordConfig } from '@modules/DiscordBot/discordHelpers';
...
export default function bootTxAdmin() {
    ...
    const _txCore: Partial<TxCoreType> = {
        configStore: new ConfigStore(),
        discordConfig: txConfig.discordBot as DiscordConfig,
    };
    ...
    (globalThis as any).txCore = _txCore as TxCoreType;
}